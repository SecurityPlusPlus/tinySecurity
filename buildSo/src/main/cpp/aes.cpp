...
static int removepading(unsigned char *padplain, unsigned long padplainlen, unsigned char *plain,
                        unsigned long *plainlen);

static void addpading(unsigned char *plain, unsigned long plainlen, unsigned char *padplain,
                      unsigned long *padplainlen);

int aes_setup(const unsigned char *key, int keylen, struct aes_key *skey);

int aes_encrypt(const unsigned char *pt, unsigned char *ct, struct aes_key *skey);

int aes_decrypt(const unsigned char *ct, unsigned char *pt, struct aes_key *skey);
...
static const unsigned long Te4_0[] = {
        ...
        0x0000006fUL, 0x000000c5UL,
        0x00000030UL, 0x00000001UL, 0x00000067UL, 0x0000002bUL, 0x000000feUL, 0x000000d7UL,
        0x000000abUL, 0x00000076UL,
        0x000000caUL, 0x00000082UL, 0x000000c9UL, 0x0000007dUL, 0x000000faUL, 0x00000059UL,
        0x00000047UL, 0x000000f0UL,
        0x000000adUL, 0x000000d4UL, 0x000000a2UL, 0x000000afUL, 0x0000009cUL, 0x000000a4UL,
        0x00000072UL, 0x000000c0UL,
        0x000000b7UL, 0x000000fdUL, 0x00000093UL, 0x00000026UL, 0x00000036UL, 0x0000003fUL,
        0x000000f7UL, 0x000000ccUL,
        0x00000034UL, 0x000000a5UL, 0x000000e5UL, 0x000000f1UL, 0x00000071UL, 0x000000d8UL,
        0x00000031UL, 0x00000015UL,
        0x00000004UL, 0x000000c7UL, 0x00000023UL, 0x000000c3UL, 0x00000018UL, 0x00000096UL,
        0x00000005UL, 0x0000009aUL,
        0x00000007UL, 0x00000012UL, 0x00000080UL, 0x000000e2UL, 0x000000ebUL, 0x00000027UL,
        0x000000b2UL, 0x00000075UL,
        0x00000009UL, 0x00000083UL, 0x0000002cUL, 0x0000001aUL, 0x0000001bUL, 0x0000006eUL,
        0x0000005aUL, 0x000000a0UL,
        0x00000052UL, 0x0000003bUL, 0x000000d6UL, 0x000000b3UL, 0x00000029UL, 0x000000e3UL,
        0x0000002fUL, 0x00000084UL,
        0x00000053UL, 0x000000d1UL, 0x00000000UL, 0x000000edUL, 0x00000020UL, 0x000000fcUL,
        0x000000b1UL, 0x0000005bUL,
        0x0000006aUL, 0x000000cbUL, 0x000000beUL, 0x00000039UL, 0x0000004aUL, 0x0000004cUL,
        0x00000058UL, 0x000000cfUL,
        0x000000d0UL, 0x000000efUL, 0x000000aaUL, 0x000000fbUL, 0x00000043UL, 0x0000004dUL,
        0x00000033UL, 0x00000085UL,
        0x00000045UL, 0x000000f9UL, 0x00000002UL, 0x0000007fUL, 0x00000050UL, 0x0000003cUL,
        0x0000009fUL, 0x000000a8UL,
        0x00000051UL, 0x000000a3UL, 0x00000040UL, 0x0000008fUL, 0x00000092UL, 0x0000009dUL,
        0x00000038UL, 0x000000f5UL,
        0x000000bcUL, 0x000000b6UL, 0x000000daUL, 0x00000021UL, 0x00000010UL, 0x000000ffUL,
        0x000000f3UL, 0x000000d2UL,
        0x000000cdUL, 0x0000000cUL, 0x00000013UL, 0x000000ecUL, 0x0000005fUL, 0x00000097UL,
        0x00000044UL, 0x00000017UL,
        0x000000c4UL, 0x000000a7UL, 0x0000007eUL, 0x0000003dUL, 0x00000064UL, 0x0000005dUL,
        0x00000019UL, 0x00000073UL,
        0x00000060UL, 0x00000081UL, 0x0000004fUL, 0x000000dcUL, 0x00000022UL, 0x0000002aUL,
        0x00000090UL, 0x00000088UL,
        0x00000046UL, 0x000000eeUL, 0x000000b8UL, 0x00000014UL, 0x000000deUL, 0x0000005eUL,
        0x0000000bUL, 0x000000dbUL,
        0x000000e0UL, 0x00000032UL, 0x0000003aUL, 0x0000000aUL, 0x00000049UL, 0x00000006UL,
        0x00000024UL, 0x0000005cUL,
        0x000000c2UL, 0x000000d3UL, 0x000000acUL, 0x00000062UL, 0x00000091UL, 0x00000095UL,
        0x000000e4UL, 0x00000079UL,
        0x000000e7UL, 0x000000c8UL, 0x00000037UL, 0x0000006dUL, 0x0000008dUL, 0x000000d5UL,
        0x0000004eUL, 0x000000a9UL,
        0x0000006cUL, 0x00000056UL, 0x000000f4UL, 0x000000eaUL, 0x00000065UL, 0x0000007aUL,
        0x000000aeUL, 0x00000008UL,
        0x000000baUL, 0x00000078UL, 0x00000025UL, 0x0000002eUL, 0x0000001cUL, 0x000000a6UL,
        0x000000b4UL, 0x000000c6UL,
        0x000000e8UL, 0x000000ddUL, 0x00000074UL, 0x0000001fUL, 0x0000004bUL, 0x000000bdUL,
        0x0000008bUL, 0x0000008aUL,
        0x00000070UL, 0x0000003eUL, 0x000000b5UL, 0x00000066UL, 0x00000048UL, 0x00000003UL,
        0x000000f6UL, 0x0000000eUL,
        0x00000061UL, 0x00000035UL, 0x00000057UL, 0x000000b9UL, 0x00000086UL, 0x000000c1UL,
        0x0000001dUL, 0x0000009eUL,
        0x000000e1UL, 0x000000f8UL, 0x00000098UL, 0x00000011UL, 0x00000069UL, 0x000000d9UL,
        0x0000008eUL, 0x00000094UL,
        0x0000009bUL, 0x0000001eUL, 0x00000087UL, 0x000000e9UL, 0x000000ceUL, 0x00000055UL,
        0x00000028UL, 0x000000dfUL,
        0x0000008cUL, 0x000000a1UL, 0x00000089UL, 0x0000000dUL, 0x000000bfUL, 0x000000e6UL,
        0x00000042UL, 0x00000068UL,
        0x00000041UL, 0x00000099UL, 0x0000002dUL, 0x0000000fUL, 0x000000b0UL, 0x00000054UL,
        0x000000bbUL, 0x00000016UL
};

static const unsigned long Te4_1[] = {
        0x00006300UL, 0x00007c00UL, 0x00007700UL, 0x00007b00UL, 0x0000f200UL, 0x00006b00UL,
        0x00006f00UL, 0x0000c500UL,
        0x00003000UL, 0x00000100UL, 0x00006700UL, 0x00002b00UL, 0x0000fe00UL, 0x0000d700UL,
        0x0000ab00UL, 0x00007600UL,
        0x0000ca00UL, 0x00008200UL, 0x0000c900UL, 0x00007d00UL, 0x0000fa00UL, 0x00005900UL,
        0x00004700UL, 0x0000f000UL,
        0x0000ad00UL, 0x0000d400UL, 0x0000a200UL, 0x0000af00UL, 0x00009c00UL, 0x0000a400UL,
        0x00007200UL, 0x0000c000UL,
        0x0000b700UL, 0x0000fd00UL, 0x00009300UL, 0x00002600UL, 0x00003600UL, 0x00003f00UL,
        0x0000f700UL, 0x0000cc00UL,
        0x00003400UL, 0x0000a500UL, 0x0000e500UL, 0x0000f100UL, 0x00007100UL, 0x0000d800UL,
        0x00003100UL, 0x00001500UL,
        0x00000400UL, 0x0000c700UL, 0x00002300UL, 0x0000c300UL, 0x00001800UL, 0x00009600UL,
        0x00000500UL, 0x00009a00UL,
        0x00000700UL, 0x00001200UL, 0x00008000UL, 0x0000e200UL, 0x0000eb00UL, 0x00002700UL,
        0x0000b200UL, 0x00007500UL,
        0x00000900UL, 0x00008300UL, 0x00002c00UL, 0x00001a00UL, 0x00001b00UL, 0x00006e00UL,
        0x00005a00UL, 0x0000a000UL,
        0x00005200UL, 0x00003b00UL, 0x0000d600UL, 0x0000b300UL, 0x00002900UL, 0x0000e300UL,
        0x00002f00UL, 0x00008400UL,
        0x00005300UL, 0x0000d100UL, 0x00000000UL, 0x0000ed00UL, 0x00002000UL, 0x0000fc00UL,
        0x0000b100UL, 0x00005b00UL,
        0x00006a00UL, 0x0000cb00UL, 0x0000be00UL, 0x00003900UL, 0x00004a00UL, 0x00004c00UL,
        0x00005800UL, 0x0000cf00UL,
        0x0000d000UL, 0x0000ef00UL, 0x0000aa00UL, 0x0000fb00UL, 0x00004300UL, 0x00004d00UL,
        0x00003300UL, 0x00008500UL,
        0x00004500UL, 0x0000f900UL, 0x00000200UL, 0x00007f00UL, 0x00005000UL, 0x00003c00UL,
        0x00009f00UL, 0x0000a800UL,
        0x00005100UL, 0x0000a300UL, 0x00004000UL, 0x00008f00UL, 0x00009200UL, 0x00009d00UL,
        0x00003800UL, 0x0000f500UL,
        0x0000bc00UL, 0x0000b600UL, 0x0000da00UL, 0x00002100UL, 0x00001000UL, 0x0000ff00UL,
        0x0000f300UL, 0x0000d200UL,
        0x0000cd00UL, 0x00000c00UL, 0x00001300UL, 0x0000ec00UL, 0x00005f00UL, 0x00009700UL,
        0x00004400UL, 0x00001700UL,
        0x0000c400UL, 0x0000a700UL, 0x00007e00UL, 0x00003d00UL, 0x00006400UL, 0x00005d00UL,
        0x00001900UL, 0x00007300UL,
        0x00006000UL, 0x00008100UL, 0x00004f00UL, 0x0000dc00UL, 0x00002200UL, 0x00002a00UL,
        0x00009000UL, 0x00008800UL,
        0x00004600UL, 0x0000ee00UL, 0x0000b800UL, 0x00001400UL, 0x0000de00UL, 0x00005e00UL,
        0x00000b00UL, 0x0000db00UL,
        0x0000e000UL, 0x00003200UL, 0x00003a00UL, 0x00000a00UL, 0x00004900UL, 0x00000600UL,
        0x00002400UL, 0x00005c00UL,
        0x0000c200UL, 0x0000d300UL, 0x0000ac00UL, 0x00006200UL, 0x00009100UL, 0x00009500UL,
        0x0000e400UL, 0x00007900UL,
        0x0000e700UL, 0x0000c800UL, 0x00003700UL, 0x00006d00UL, 0x00008d00UL, 0x0000d500UL,
        0x00004e00UL, 0x0000a900UL,
        0x00006c00UL, 0x00005600UL, 0x0000f400UL, 0x0000ea00UL, 0x00006500UL, 0x00007a00UL,
        0x0000ae00UL, 0x00000800UL,
        0x0000ba00UL, 0x00007800UL, 0x00002500UL, 0x00002e00UL, 0x00001c00UL, 0x0000a600UL,
        0x0000b400UL, 0x0000c600UL,
        0x0000e800UL, 0x0000dd00UL, 0x00007400UL, 0x00001f00UL, 0x00004b00UL, 0x0000bd00UL,
        0x00008b00UL, 0x00008a00UL,
        0x00007000UL, 0x00003e00UL, 0x0000b500UL, 0x00006600UL, 0x00004800UL, 0x00000300UL,
        0x0000f600UL, 0x00000e00UL,
        0x00006100UL, 0x00003500UL, 0x00005700UL, 0x0000b900UL, 0x00008600UL, 0x0000c100UL,
        0x00001d00UL, 0x00009e00UL,
        0x0000e100UL, 0x0000f800UL, 0x00009800UL, 0x00001100UL, 0x00006900UL, 0x0000d900UL,
        0x00008e00UL, 0x00009400UL,
        0x00009b00UL, 0x00001e00UL, 0x00008700UL, 0x0000e900UL, 0x0000ce00UL, 0x00005500UL,
        0x00002800UL, 0x0000df00UL,
        0x00008c00UL, 0x0000a100UL, 0x00008900UL, 0x00000d00UL, 0x0000bf00UL, 0x0000e600UL,
        0x00004200UL, 0x00006800UL,
        0x00004100UL, 0x00009900UL, 0x00002d00UL, 0x00000f00UL, 0x0000b000UL, 0x00005400UL,
        0x0000bb00UL, 0x00001600UL
};

static const unsigned long Te4_2[] = {
        0x00630000UL, 0x007c0000UL, 0x00770000UL, 0x007b0000UL, 0x00f20000UL, 0x006b0000UL,
        0x006f0000UL, 0x00c50000UL,
        0x00300000UL, 0x00010000UL, 0x00670000UL, 0x002b0000UL, 0x00fe0000UL, 0x00d70000UL,
        0x00ab0000UL, 0x00760000UL,
        0x00ca0000UL, 0x00820000UL, 0x00c90000UL, 0x007d0000UL, 0x00fa0000UL, 0x00590000UL,
        0x00470000UL, 0x00f00000UL,
        0x00ad0000UL, 0x00d40000UL, 0x00a20000UL, 0x00af0000UL, 0x009c0000UL, 0x00a40000UL,
        0x00720000UL, 0x00c00000UL,
        0x00b70000UL, 0x00fd0000UL, 0x00930000UL, 0x00260000UL, 0x00360000UL, 0x003f0000UL,
        0x00f70000UL, 0x00cc0000UL,
        0x00340000UL, 0x00a50000UL, 0x00e50000UL, 0x00f10000UL, 0x00710000UL, 0x00d80000UL,
        0x00310000UL, 0x00150000UL,
        0x00040000UL, 0x00c70000UL, 0x00230000UL, 0x00c30000UL, 0x00180000UL, 0x00960000UL,
        0x00050000UL, 0x009a0000UL,
        0x00070000UL, 0x00120000UL, 0x00800000UL, 0x00e20000UL, 0x00eb0000UL, 0x00270000UL,
        0x00b20000UL, 0x00750000UL,
        0x00090000UL, 0x00830000UL, 0x002c0000UL, 0x001a0000UL, 0x001b0000UL, 0x006e0000UL,
        0x005a0000UL, 0x00a00000UL,
        0x00520000UL, 0x003b0000UL, 0x00d60000UL, 0x00b30000UL, 0x00290000UL, 0x00e30000UL,
        0x002f0000UL, 0x00840000UL,
        0x00530000UL, 0x00d10000UL, 0x00000000UL, 0x00ed0000UL, 0x00200000UL, 0x00fc0000UL,
        0x00b10000UL, 0x005b0000UL,
        0x006a0000UL, 0x00cb0000UL, 0x00be0000UL, 0x00390000UL, 0x004a0000UL, 0x004c0000UL,
        0x00580000UL, 0x00cf0000UL,
        0x00d00000UL, 0x00ef0000UL, 0x00aa0000UL, 0x00fb0000UL, 0x00430000UL, 0x004d0000UL,
        0x00330000UL, 0x00850000UL,
        0x00450000UL, 0x00f90000UL, 0x00020000UL, 0x007f0000UL, 0x00500000UL, 0x003c0000UL,
        0x009f0000UL, 0x00a80000UL,
        0x00510000UL, 0x00a30000UL, 0x00400000UL, 0x008f0000UL, 0x00920000UL, 0x009d0000UL,
        0x00380000UL, 0x00f50000UL,
        0x00bc0000UL, 0x00b60000UL, 0x00da0000UL, 0x00210000UL, 0x00100000UL, 0x00ff0000UL,
        0x00f30000UL, 0x00d20000UL,
        0x00cd0000UL, 0x000c0000UL, 0x00130000UL, 0x00ec0000UL, 0x005f0000UL, 0x00970000UL,
        0x00440000UL, 0x00170000UL,
        0x00c40000UL, 0x00a70000UL, 0x007e0000UL, 0x003d0000UL, 0x00640000UL, 0x005d0000UL,
        0x00190000UL, 0x00730000UL,
        0x00600000UL, 0x00810000UL, 0x004f0000UL, 0x00dc0000UL, 0x00220000UL, 0x002a0000UL,
        0x00900000UL, 0x00880000UL,
        0x00460000UL, 0x00ee0000UL, 0x00b80000UL, 0x00140000UL, 0x00de0000UL, 0x005e0000UL,
        0x000b0000UL, 0x00db0000UL,
        0x00e00000UL, 0x00320000UL, 0x003a0000UL, 0x000a0000UL, 0x00490000UL, 0x00060000UL,
        0x00240000UL, 0x005c0000UL,
        0x00c20000UL, 0x00d30000UL, 0x00ac0000UL, 0x00620000UL, 0x00910000UL, 0x00950000UL,
        0x00e40000UL, 0x00790000UL,
        0x00e70000UL, 0x00c80000UL, 0x00370000UL, 0x006d0000UL, 0x008d0000UL, 0x00d50000UL,
        0x004e0000UL, 0x00a90000UL,
        0x006c0000UL, 0x00560000UL, 0x00f40000UL, 0x00ea0000UL, 0x00650000UL, 0x007a0000UL,
        0x00ae0000UL, 0x00080000UL,
        0x00ba0000UL, 0x00780000UL, 0x00250000UL, 0x002e0000UL, 0x001c0000UL, 0x00a60000UL,
        0x00b40000UL, 0x00c60000UL,
        0x00e80000UL, 0x00dd0000UL, 0x00740000UL, 0x001f0000UL, 0x004b0000UL, 0x00bd0000UL,
        0x008b0000UL, 0x008a0000UL,
        0x00700000UL, 0x003e0000UL, 0x00b50000UL, 0x00660000UL, 0x00480000UL, 0x00030000UL,
        0x00f60000UL, 0x000e0000UL,
        0x00610000UL, 0x00350000UL, 0x00570000UL, 0x00b90000UL, 0x00860000UL, 0x00c10000UL,
        0x001d0000UL, 0x009e0000UL,
        0x00e10000UL, 0x00f80000UL, 0x00980000UL, 0x00110000UL, 0x00690000UL, 0x00d90000UL,
        0x008e0000UL, 0x00940000UL,
        0x009b0000UL, 0x001e0000UL, 0x00870000UL, 0x00e90000UL, 0x00ce0000UL, 0x00550000UL,
        0x00280000UL, 0x00df0000UL,
        0x008c0000UL, 0x00a10000UL, 0x00890000UL, 0x000d0000UL, 0x00bf0000UL, 0x00e60000UL,
        0x00420000UL, 0x00680000UL,
        0x00410000UL, 0x00990000UL, 0x002d0000UL, 0x000f0000UL, 0x00b00000UL, 0x00540000UL,
        0x00bb0000UL, 0x00160000UL
};

static const unsigned long Te4_3[] = {
        0x63000000UL, 0x7c000000UL, 0x77000000UL, 0x7b000000UL, 0xf2000000UL, 0x6b000000UL,
        0x6f000000UL, 0xc5000000UL,
        0x30000000UL, 0x01000000UL, 0x67000000UL, 0x2b000000UL, 0xfe000000UL, 0xd7000000UL,
        0xab000000UL, 0x76000000UL,
        0xca000000UL, 0x82000000UL, 0xc9000000UL, 0x7d000000UL, 0xfa000000UL, 0x59000000UL,
        0x47000000UL, 0xf0000000UL,
        0xad000000UL, 0xd4000000UL, 0xa2000000UL, 0xaf000000UL, 0x9c000000UL, 0xa4000000UL,
        0x72000000UL, 0xc0000000UL,
        0xb7000000UL, 0xfd000000UL, 0x93000000UL, 0x26000000UL, 0x36000000UL, 0x3f000000UL,
        0xf7000000UL, 0xcc000000UL,
        0x34000000UL, 0xa5000000UL, 0xe5000000UL, 0xf1000000UL, 0x71000000UL, 0xd8000000UL,
        0x31000000UL, 0x15000000UL,
        0x04000000UL, 0xc7000000UL, 0x23000000UL, 0xc3000000UL, 0x18000000UL, 0x96000000UL,
        0x05000000UL, 0x9a000000UL,
        0x07000000UL, 0x12000000UL, 0x80000000UL, 0xe2000000UL, 0xeb000000UL, 0x27000000UL,
        0xb2000000UL, 0x75000000UL,
        0x09000000UL, 0x83000000UL, 0x2c000000UL, 0x1a000000UL, 0x1b000000UL, 0x6e000000UL,
        0x5a000000UL, 0xa0000000UL,
        0x52000000UL, 0x3b000000UL, 0xd6000000UL, 0xb3000000UL, 0x29000000UL, 0xe3000000UL,
        0x2f000000UL, 0x84000000UL,
        0x53000000UL, 0xd1000000UL, 0x00000000UL, 0xed000000UL, 0x20000000UL, 0xfc000000UL,
        0xb1000000UL, 0x5b000000UL,
        0x6a000000UL, 0xcb000000UL, 0xbe000000UL, 0x39000000UL, 0x4a000000UL, 0x4c000000UL,
        0x58000000UL, 0xcf000000UL,
        0xd0000000UL, 0xef000000UL, 0xaa000000UL, 0xfb000000UL, 0x43000000UL, 0x4d000000UL,
        0x33000000UL, 0x85000000UL,
        0x45000000UL, 0xf9000000UL, 0x02000000UL, 0x7f000000UL, 0x50000000UL, 0x3c000000UL,
        0x9f000000UL, 0xa8000000UL,
        0x51000000UL, 0xa3000000UL, 0x40000000UL, 0x8f000000UL, 0x92000000UL, 0x9d000000UL,
        0x38000000UL, 0xf5000000UL,
        0xbc000000UL, 0xb6000000UL, 0xda000000UL, 0x21000000UL, 0x10000000UL, 0xff000000UL,
        0xf3000000UL, 0xd2000000UL,
        0xcd000000UL, 0x0c000000UL, 0x13000000UL, 0xec000000UL, 0x5f000000UL, 0x97000000UL,
        0x44000000UL, 0x17000000UL,
        0xc4000000UL, 0xa7000000UL, 0x7e000000UL, 0x3d000000UL, 0x64000000UL, 0x5d000000UL,
        0x19000000UL, 0x73000000UL,
        0x60000000UL, 0x81000000UL, 0x4f000000UL, 0xdc000000UL, 0x22000000UL, 0x2a000000UL,
        0x90000000UL, 0x88000000UL,
        0x46000000UL, 0xee000000UL, 0xb8000000UL, 0x14000000UL, 0xde000000UL, 0x5e000000UL,
        0x0b000000UL, 0xdb000000UL,
        0xe0000000UL, 0x32000000UL, 0x3a000000UL, 0x0a000000UL, 0x49000000UL, 0x06000000UL,
        0x24000000UL, 0x5c000000UL,
        0xc2000000UL, 0xd3000000UL, 0xac000000UL, 0x62000000UL, 0x91000000UL, 0x95000000UL,
        0xe4000000UL, 0x79000000UL,
        0xe7000000UL, 0xc8000000UL, 0x37000000UL, 0x6d000000UL, 0x8d000000UL, 0xd5000000UL,
        0x4e000000UL, 0xa9000000UL,
        0x6c000000UL, 0x56000000UL, 0xf4000000UL, 0xea000000UL, 0x65000000UL, 0x7a000000UL,
        0xae000000UL, 0x08000000UL,
        0xba000000UL, 0x78000000UL, 0x25000000UL, 0x2e000000UL, 0x1c000000UL, 0xa6000000UL,
        0xb4000000UL, 0xc6000000UL,
        0xe8000000UL, 0xdd000000UL, 0x74000000UL, 0x1f000000UL, 0x4b000000UL, 0xbd000000UL,
        0x8b000000UL, 0x8a000000UL,
        0x70000000UL, 0x3e000000UL, 0xb5000000UL, 0x66000000UL, 0x48000000UL, 0x03000000UL,
        0xf6000000UL, 0x0e000000UL,
        0x61000000UL, 0x35000000UL, 0x57000000UL, 0xb9000000UL, 0x86000000UL, 0xc1000000UL,
        0x1d000000UL, 0x9e000000UL,
        0xe1000000UL, 0xf8000000UL, 0x98000000UL, 0x11000000UL, 0x69000000UL, 0xd9000000UL,
        0x8e000000UL, 0x94000000UL,
        0x9b000000UL, 0x1e000000UL, 0x87000000UL, 0xe9000000UL, 0xce000000UL, 0x55000000UL,
        0x28000000UL, 0xdf000000UL,
        0x8c000000UL, 0xa1000000UL, 0x89000000UL, 0x0d000000UL, 0xbf000000UL, 0xe6000000UL,
        0x42000000UL, 0x68000000UL,
        0x41000000UL, 0x99000000UL, 0x2d000000UL, 0x0f000000UL, 0xb0000000UL, 0x54000000UL,
        0xbb000000UL, 0x16000000UL
};
...
static unsigned long setup_mix(unsigned long temp) {
...
static unsigned long setup_mix2(unsigned long temp) {
...
/**
   Initialize the AESMode (Rijndael) block cipher
...
*/
int aes_setup(const unsigned char *key, int keylen, struct aes_key *skey) {
    int i, j, num_rounds = 0;
    unsigned long temp, *rk;
    unsigned long *rrk;
    if (NULL == key || NULL == skey)
        return 1;
...
/**
  Encrypts a block of text with AESMode
...
/**
  Performs a self-test of the AESMode block cipher
...
*/
void aes_done(struct aes_key *skey) {
}

static void
addpading(unsigned char *in, unsigned long inlen, unsigned char *out, unsigned long *outlen) {
    int padlen = inlen % 16;
    if (inlen == 0) {
        memcpy(out, in, inlen);
        memset(out + inlen, 0x10, 16);
        *outlen = inlen + 16;
    } else {
        memcpy(out, in, inlen);
        memset(out + inlen, 16 - padlen, 16 - padlen);
        *outlen = inlen + 16 - padlen;
    }
...
static int removepading(unsigned char *padplain, unsigned long padplainlen, unsigned char *plain,
                        unsigned long *plainlen) {
    int ret = 0;
    int removebyte = (int) padplain[padplainlen - 1];
    if (removebyte > 16 || removebyte <= 0)
        return SYM_DEC_FAILED;
    *plainlen = padplainlen - removebyte;
    memcpy(plain, padplain, *plainlen);
    return ret;
}

/*****************************4种分组模式***************************************/
int
ecb_encrypt(const unsigned char *pt, unsigned char *ct, unsigned long len, struct aes_key *skey) {
    int ret = 0;
    int block_length = 16;
    if (NULL == pt || NULL == ct || NULL == skey || len == 0)
        return PARAM_ERROR;


    /* check for accel */
    while (len) {
        if ((ret = aes_encrypt(pt, ct, skey)) != 0) {
            return ret;
        }
        pt += block_length;
        ct += block_length;
...
int
ecb_decrypt(const unsigned char *ct, unsigned char *pt, unsigned long len, struct aes_key *skey) {
    int ret;
    int block_length = 16;
    if (NULL == pt || NULL == ct || NULL == skey || len == 0)
        return PARAM_ERROR;
    ...
    /* check for accel */
    while (len) {
        if ((ret = aes_decrypt(ct, pt, skey)) != 0) {
            return ret;
        }
        pt += block_length;
        ct += block_length;
...
int cbc_encrypt(unsigned char *IV, const unsigned char *pt, unsigned char *ct,
                unsigned long len, struct aes_key *skey) {
    int x, ret;
    int block_length = 16;
    if (NULL == pt || NULL == ct || len == 0 || NULL == skey || NULL == IV)
        return PARAM_ERROR;

    while (len) {
        /* xor ENCRYPT_IV against plaintext */
        ...
        /* encrypt */
        if ((ret = aes_encrypt(IV, ct, skey)) != 0) {
            return ret;
        }

        /* store ENCRYPT_IV [ciphertext] for a future block */
        for (x = 0; x < block_length; x++) {
            IV[x] = ct[x];
        }
...
int cbc_decrypt(unsigned char *IV, const unsigned char *ct, unsigned char *pt,
                unsigned long len, struct aes_key *skey) {
    int x, ret;
    ...
    while (len) {
        /* decrypt */
        if ((ret = aes_decrypt(ct, tmp, skey)) != 0) {
            return ret;
        }
...
int cfb_encrypt(unsigned char *IV, const unsigned char *pt, unsigned char *ct,
                unsigned long len, struct aes_key *skey) {
    int ret;
    int padlen = 16, blocklen = 16;
    unsigned char pad[128] = {0};
    memset(pad, 0, 128);
    if (NULL == IV || NULL == pt || NULL == ct || len == 0 || NULL == skey)
        return PARAM_ERROR;


    while (len-- > 0) {
        if (padlen == blocklen) {
            if ((ret = aes_encrypt(IV, pad, skey)) != 0) {
                return ret;
            }
            padlen = 0;
        }
        IV[padlen] = (*ct = *pt ^ pad[padlen]);
        ++pt;
        ++ct;
        ++(padlen);
    }
...
int cfb_decrypt(unsigned char *IV, const unsigned char *ct, unsigned char *pt,
                unsigned long len, struct aes_key *skey) {
    int ret = 0, padlen = 16, blocklen = 16;
    unsigned char pad[128] = {0};
    memset(pad, 0, 128);
    if (NULL == IV || NULL == pt || NULL == ct || len == 0 || NULL == skey)
        return PARAM_ERROR;
...
int ofb_encrypt(unsigned char *IV, const unsigned char *pt, unsigned char *ct,
                unsigned long len, struct aes_key *skey) {
    int ret = 0, blocklen = 16, padlen = 16;
    if (NULL == IV || NULL == pt || NULL == ct || len == 0 || NULL == skey)
        return PARAM_ERROR;
    while (len-- > 0) {
        if (padlen == blocklen) {
            if ((ret = aes_encrypt(IV, IV, skey)) != 0) {
                return ret;
            }
            padlen = 0;
        }
...
int ofb_decrypt(unsigned char *IV, const unsigned char *ct, unsigned char *pt,
                unsigned long len, struct aes_key *skey) {
    if (NULL == IV || NULL == pt || NULL == ct || len == 0 || NULL == skey)
        return PARAM_ERROR;
    return ofb_encrypt(IV, ct, pt, len, skey);
}


int aesEncrypt(int mode, unsigned char *IV, unsigned char *plain, unsigned long plainlen,
               unsigned char *cipher,
               unsigned long *cipherlen, unsigned char *key, unsigned long keylen) {
    int ret = 0;
    struct aes_key *skey = (aes_key *) malloc(sizeof(aes_key));
    unsigned long plainpadinglen = plainlen + 16;
    unsigned char *plainpading = (unsigned char *) malloc((plainlen + 16) * sizeof(unsigned char));
    memset(plainpading, 0, plainlen + 16);
    addpading(plain, plainlen, plainpading, &plainpadinglen);
    if (keylen != 16)
        return PARAM_ERROR;
    aes_setup(key, 16, skey);
    unsigned char innerIV[16] = {0};
    if (IV) {
        memcpy(innerIV, IV, 16 * sizeof(IV[0]));
    }
    switch (mode) {
        case ECB: {
            ret = ecb_encrypt(plainpading, cipher, plainpadinglen, skey);
            if (ret != 0) {
                free(skey);
                free(plainpading);
                return ret;
            }
            *cipherlen = plainpadinglen;
            free(skey);
            free(plainpading);
            return ret;
        }
        case CBC: {
            ret = cbc_encrypt(innerIV, plainpading, cipher, plainpadinglen, skey);
            if (ret != 0) {
                free(skey);
                free(plainpading);
                return ret;
        ...
        case CFB: {
            ret = cfb_encrypt(innerIV, plain, cipher, plainlen, skey);
            if (ret != 0) {
                free(skey);
                free(plainpading);
                return ret;
        ...
        case OFB: {
            ret = ofb_encrypt(innerIV, plain, cipher, plainlen, skey);
            if (ret != 0) {
                free(skey);
                free(plainpading);
                return ret;
...
int aesDecrypt(int mode, unsigned char *IV, unsigned char *cipher, unsigned long cipherlen,
               unsigned char *plain, unsigned long *plainlen, unsigned char *key,
               unsigned long keylen) {
    int count = 0, i = 0, ret = 0;
    unsigned char *plainpading = (unsigned char *) malloc(cipherlen * sizeof(unsigned char));
    struct aes_key *skey = (aes_key *) malloc(sizeof(aes_key));
    if (keylen != 16)
        return PARAM_ERROR;
    aes_setup(key, 16, skey);
    ...
    switch (mode) {
        case ECB: {
            ret = ecb_decrypt(cipher, plainpading, cipherlen, skey);
            if (ret != 0) {
                free(skey);
                free(plainpading);
                return ret;
            }
            ret = removepading(plainpading, cipherlen, plain, plainlen);
            if (ret != 0) {
                free(skey);
                free(plainpading);
                return ret;
        ...
        case CBC: {
            ret = cbc_decrypt(innerIV, cipher, plainpading, cipherlen, skey);
            if (ret != 0) {
                free(skey);
                free(plainpading);
                return ret;
        ...
        case CFB: {
            ret = cfb_decrypt(innerIV, cipher, plain, cipherlen, skey);
            if (ret != 0) {
                free(skey);
                free(plainpading);
                return ret;
        ...
        case OFB: {
            ret = ofb_decrypt(innerIV, cipher, plain, cipherlen, skey);
            if (ret != 0) {
                free(skey);
                free(plainpading);
                return ret;
