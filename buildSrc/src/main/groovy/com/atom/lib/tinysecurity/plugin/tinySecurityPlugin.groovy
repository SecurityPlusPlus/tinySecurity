package com.atom.lib.tinysecurity.plugin

import com.android.build.gradle.AppExtension
import com.atom.lib.tinysecurity.extension.TinySecurityExt
import com.atom.lib.tinysecurity.generater.CMakeListsBuilder
import com.atom.lib.tinysecurity.task.GenerateSecurityDataFileTask
import com.atom.lib.tinysecurity.task.GenerateJavaClientFileTask
import com.atom.lib.tinysecurity.utils.IOUtils
...
class tinySecurityPlugin implements Plugin<Project> {
    ...
    private File generateCMakeListsFile(Project project, String originCMakeListsPath) {
        ...
        new CMakeListsBuilder("${project.buildDir.canonicalPath}/tinySecurity/CMakeLists.txt")
